...
<html>
  <head>
    ...
    <script type="text/javascript">
    	$(function(){
    		...
    		//开发失败
   		 $("#stop").click(function(){
   			var href = "${ctp}/plan/chance/stop?id=${chance.id }" ;
   			 alert(href);
   			$("#stopForm").attr("action",href).submit();
   			return false;
   		}); 
   		
   		//开发成功
   		$("#finish").click(function(){
   			var href = "${ctp}/plan/chance/finish?id=${chance.id }";
   			alert(href);
  ...
  <br>
	...
	<div class="button_bar">
		...
		<button class="common_button" onclick="window.location.href='${ctp}/plan/make?id=${chance.id }'">制定计划</button>
