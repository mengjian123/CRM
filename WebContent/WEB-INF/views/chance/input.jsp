...
<html>
 ...
 <body class="main">
	...
	<!--  
		restful url:
		Create: /crm/chance       POST
		Read:   /crm/chance/{id}  GET
		Update  /crm/chance/{id}  PUT
		Delete  /crm/chance/{id}  DELETE
		
		指派任务给 User 对象.
		/crm/chance/designee/{id} GET 显示指派的页面
		/crm/chance/designee/{id} PUT 完成指派操作
	-->
